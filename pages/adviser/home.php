...
<body class="theme-blue">
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="email">santiepelayo@example.com</div>
    ...
    <section class="content">
     ...
     <?php 
            $stmt=$dbh->prepare('SELECT * FROM tbl_pictures ORDER BY id DESC');
                $stmt->execute();
                if($stmt->rowCount()>0)
                {
            ...
            <img src="../uploads/<?php echo $row['picture']?>"><br><br>
