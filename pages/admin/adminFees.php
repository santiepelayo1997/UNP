            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                                <button type="button" class="btn btn-info waves-effect" style="border-radius:20px;">Add New Fee</button>&nbsp;&nbsp;
                            <button type="button" class="btn btn-info waves-effect"  style="border-radius:20px;">Update Fee</button>&nbsp;&nbsp;
                             <button type="button" class="btn btn-danger waves-effect"  style="border-radius:20px;">Delete Fee</button>&nbsp;&nbsp;
                             <br></br>
                            <table id="mainTable" class="table table-striped table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Cost</th>
